...
import starts from "@/assets/images/reviewstarts.png";
  ...
  return (
    <div className="">
      <div className="flex justify-center gap-x-19 texts_16_medium text-[#767676]">
        {/* Buttons  */}
        <button className="relative hover:text-head after:content-[''] after:block after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-25 after:bg-head after:transition-all after:duration-300">
          DESCRIPTION
        </button>
        <button className="relative hover:text-head after:content-[''] after:block after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-25 after:bg-head after:transition-all after:duration-300">
      ...
      <div className={"px-60 mt-12.5"}>
        <Container>
          ...
          {/* ADDITIONAL INFORMATION  */}
          <div className="flex gap-x-22.5 my-12.5">
