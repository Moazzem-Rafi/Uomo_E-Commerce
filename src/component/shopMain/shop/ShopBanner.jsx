            ...
            <div className="flex justify-between items-center pt-3.25">
              <div className="">
                <ul className="flex gap-x-8 pb-34.75">
                  <li className="texts_16_medium text-head">
                    <Link>#STAYHOME</Link>
                  </li>
                  <li className="texts_16_medium text-head">
                    <Link>NEW IN</Link>
                  ...
                  <li className="texts_16_medium text-head relative after:absolute after:content-[''] after:w-[55%] after:h-[2px] after:bg-head after:bottom-[-3px] after:left-[-15px] hover:after:w-full  after:duration-500 after:ease-in-out">
                    <Link>HOODIES</Link>
                  </li>
                  <li className="texts_16_medium text-head">
                    <Link>MEN</Link>
